let items = [
    {id: 0, name:'Gaming chair', price:69.99, source:"assets/images/chair.png", cart:0},
    {id: 1, name:'Gamer Desk', price:89.99, source:"assets/images/desk.png", cart:0},
    {id: 2, name:'Prime Gamer Desk', price:134.99, source:"assets/images/gaming-desk.png", cart:0},
    {id: 3, name:'Gamer Bed', price:249.99, source:"assets/images/bed.png", cart:0},
    {id: 4, name:'Gamer Lamp', price:19.99, source:"assets/images/lamp.png", cart:0},
    {id: 5, name:'Gamer Sofa', price:84.99, source: "assets/images/sofa.png", cart:0},
    {id: 6, name:'Gamer Shelf', price:34.99, source: "assets/images/shelf.jpg", cart:0}
];
...
function minusOne(num) {
    ...
    if (Number(items[num].cart) == 0) {
        ...
        priceHtml.innerText = `${(total).toFixed(2)} €`;

        // Main div with everything related to item inside
        let divToTouch = document.getElementsByClassName(`div-item${num}`);

        let divToAim = document.getElementById("appendable");

        divToAim.removeChild(divToTouch[0]);
    } else {
        // Main div with everything related to item inside
        let divToTouch = document.getElementsByClassName(`div-item${num}`);
